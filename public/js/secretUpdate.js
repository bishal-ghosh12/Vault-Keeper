...
async function encrypt(data, salt, aeskey, iv) {
    return new Promise(
       async function(resolve, reject) {
        ...
        console.log('encrypted Bytes id: '+encryptedBytes);
        // console.log(salt);
...
const myFORM = document.getElementById('myformUpdateDelete');
const updateFORM = document.getElementById('update');
// async function updateMyForm() {
updateFORM.addEventListener('click', async function(event) {
    ...
    console.log('Hello Secret Update');
    ...
    document.getElementById('updatepassword').value = passwordEncrypted;
    document.getElementById('updatelogin').value = loginEncrypted;
    myFORM.submit();
    return false;
});
